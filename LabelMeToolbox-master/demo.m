...
HOMEIMAGES = 'D:\aog\Images'; % you can set here your default folder
HOMEANNOTATIONS = 'D:\aog\Annotations'; % you can set here your default folder
dbstop if error
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PART 1) MANIPULATION OF INDIVIDUAL FILES:

% select one annotation file from one of the folders:
filename = fullfile(HOMEANNOTATIONS, '05june05_static_indoor\p1010846.xml');
